...
public interface ProductListSearchApi {
    ...
    @FormUrlEncoded
        Call<ProductListResponse> getProductSearch(@Field("category_ids") String category_ids, @Field("brand_id") String brand_id, @Field("search_phrase") String search_phrase, @Field("page") String page, @Field("user_id") String userId);
}
