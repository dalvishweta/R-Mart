...
public interface ProductFromInventoryListSearchApi {
    ...
    Call<ProductFromInventoryListResponse> getProductSearch(
            @Field("category_ids") String category_ids, @Field("mobile") String mobile, @Field("brand_id") String brand_id, @Field("search_phrase") String search_phrase, @Field("page") String page);
}
