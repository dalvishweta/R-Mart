...
public class ProductListViewModel extends ViewModel {
    ...
    public void loadProductList(Context context, ShopDetailsModel productsShopDetailsModel, String categoeryid, String searchPrase, String start_page, String sub_category_id, String productstype){
        isLoading.setValue(true);
        ProductsRepository.getVenderProducts(context,productsShopDetailsModel.getVendorId(),productsShopDetailsModel.getShopId(), categoeryid, searchPrase,start_page, sub_category_id,productstype).observeForever(productResult -> {
