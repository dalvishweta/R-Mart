...
public interface OrderSummaryApi {
    ...
    Call<OrderedSummaryResponse> showCartOrderDetails(@Field("client_id") String clientId, @Field("vendor_id") int vendorId, @Field("shop_id") int shop_id,
                                                      @Field("user_address_id") String user_address_id, @Field("customer_id") String customerId, @Field("delivery_method") String delivery_method, @Field("coupon_code") String coupon_code, @Field("role_id") String role_id);
}
