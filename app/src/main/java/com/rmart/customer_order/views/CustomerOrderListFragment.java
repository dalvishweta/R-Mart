...
public class CustomerOrderListFragment extends BaseOrderFragment implements View.OnClickListener {
    ...
    private void getOrdersOfStatesFromServer() {
        ...
        customerOrderService.getStateOfOrder(startIndex, MyProfile.getInstance(getContext()).getMobileNumber(),MyProfile.getInstance(getContext()).getRoleID()).enqueue(new Callback<OrdersByStatus>() {
            @Override
