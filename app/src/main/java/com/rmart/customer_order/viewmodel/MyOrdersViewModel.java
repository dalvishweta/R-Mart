package com.rmart.customer_order.viewmodel;
...
import com.rmart.R;
import com.rmart.customer_order.models.OrderObject;
import com.rmart.customer_order.models.ProductObject;
import com.rmart.customer_order.models.SelectedOrderGroup;
...
public class MyOrdersViewModel extends ViewModel implements Serializable {
    ...
    public MyOrdersViewModel() {
        ...
        setAcceptedOrders(new SelectedOrderGroup("Accepted Orders", R.drawable.item_accepted_top_bg,R.drawable.item_accepted_bottom_bg, generateProductList("Accepted", 0, 0, true)));
